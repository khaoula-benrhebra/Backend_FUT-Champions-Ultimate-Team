...
<body>
    <header>
        ...
        <div class="logosec">
            <img src="./assets/media/icons/burger-bar.png" class="icn menuicn" id="menuicn" alt="menu-icon">
        </div>

        <div class="searchbar">
            <input type="text" placeholder="Search">
            <div class="searchbtn">
                <img src="./assets/media/icons/search.png" class="icn srchicn" alt="search-icon">
            </div>
        </div>
        ...
        <div class="message">
            ...
            <div class="dp">
                <img src="./assets/media/icons/Profil.png" class="dpicn" alt="dp">
            </div>
        </div>
            ...
            <nav class="nav">
                <div class="nav-upper-options">
                    ...
                    <div class="nav-option option2">
                        <img src="assets/media/icons/stadium.png" class="nav-img" alt="institution">
                        <a href="./stadium.php"> Stadium</a>
                    </div>

                    <div class="option3 nav-option">
                        <img src="assets/media/icons/soccer-player.png" class="nav-img" alt="articles">
                        <a href="./players.php"> Players</a>
                    </div>

                    <div class="nav-option option4">
                        <img src="./assets/media/icons/report.png" class="nav-img" alt="report">
                        <h3> Report</h3>
                    </div>

                    <div class="nav-option option5">
                        <img src="./assets/media/icons/user.png" class="nav-img" alt="blog">
                        <h3> Profile</h3>
                    </div>

                    <div class="nav-option option6">
                        <img src="./assets/media/icons/settings.png" class="nav-img" alt="settings">
                        <h3> Settings</h3>
                    </div>

                    <div class="nav-option logout">
                        <img src="./assets/media/icons/login.png" class="nav-img" alt="logout">
                        <h3>Logout</h3>
                    </div>
        ...
        <div class="main">
            ...
            <div class="box-container">
                ...
                <div class="box box1">
                    ...
                    <img src="./assets/media/icons/soccer-player-white.png" alt="Player">
                </div>
                ...
                <div class="box box2">
                    ...
                    <img src="./assets/media/icons/nationnality.png" alt="nationality">
                </div>
                ...
                <div class="box box3">
                    ...
                    <img src="./assets/media/icons/football-club.png" alt="comments">
                </div>
                                            ...
                                            <form class="space-y-6 flex flex-col" id="myForm"
                                                ...
                                                <div id="general-Inf">
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                                        ...
                                                        <div class="flex flex-col">
                                                            <select name="position" id="position"
                                                                class="p-2 border border-gray-900 rounded-md bg-gray-800 text-white"
                                                                onchange="plyerAndgk()">
                                                                <option id="ChoisireJoueur" value="ChoisireJoueur">
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                        ...
                                                        <div class="flex flex-col items-center gap-2">
                                                            ...
                                                            <div class="flex flex-col">
                                                                <select name="nationnaliteSelect"
                                                                    id="nationnaliteSelect"
                                                                    class="p-2 border border-gray-900 rounded-md bg-gray-800 text-white">
                                                                    <option id="ChoisireNationnalité"
                                                                        value="ChoisireNationnalité">
                                                                        Choisissez La Naionnalité
                                                                    </option>
                                                                    <option value="GK">GK (Gardien de but)</option>
                                                                    <option value="LB">LB (Arrière gauche)</option>
                                                                    <option value="CB">CB (Défenseur central)</option>
                                                        ...
                                                        <div class="flex flex-col items-center gap-2">
                                                            ...
                                                            <!-- <input type="text" placeholder="Club" name="club"
                                                                class="p-2 border border-gray-300 rounded-md bg-gray-800 text-white"> -->
                                                            <div class="flex flex-col">
                                                                <select name="clubSelect" id="position"
                                                                    class="p-2 border border-gray-900 rounded-md bg-gray-800 text-white">
                                                                    <option id="ChoisireClub" value="ChoisireClub">
                                                                        Choisissez Le Club
                                                                    </option>
                                                                    <option value="GK">GK (Gardien de but)</option>
                                                                    <option value="LB">LB (Arrière gauche)</option>
                                                ...
                                                <div class="divise">
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                            <div class="flex flex-col">
                                                                ...
                                                                <input type="number" placeholder="Note" name="rating"
                                                                    class="p-2 border border-gray-300 rounded-md bg-gray-800 text-white">
                                                                <p class="error-msg text-red-500 text-sm font-semibold mt-1"
                                                                    style="display: none;">Note entre 10 et 99
                                                                </p>
                                                            </div>
                                                            <div>
                                                                ...
                                                                <input type="number" placeholder="Vitesse" name="pace"
                                                                    class="p-2 border border-gray-300 rounded-md bg-gray-800 text-white">
                                                                <p class="error-msg text-red-500 text-sm font-semibold mt-1"
                                                                    style="display: none;">Vitesse entre 10 et
                                                                    99</p>
                                                            </div>
                                                            <div>
                                                                ...
                                                                <input type="number" placeholder="Tir" name="shooting"
                                                                    class="p-2 border border-gray-300 rounded-md bg-gray-800 text-white">
                                                                <p class="error-msg text-red-500 text-sm font-semibold mt-1"
                                                                    style="display: none;">Tir entre 10 et 99
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                            <div>
                                                                ...
                                                                <input type="number" placeholder="Passe" name="passing"
                                                                    class="p-2 border border-gray-300 rounded-md bg-gray-800 text-white">
                                                                <p class="error-msg text-red-500 text-sm font-semibold mt-1"
                                                                    style="display: none;">Passe entre 10 et 99
                                                                </p>
                                                            </div>
                                                            <div>
                                                                <!-- <label for="dribbling">DRI</label> -->
                                                                <input type="number" placeholder="Dribble"
                                                                    name="dribbling"
                                                                    class="p-2 border border-gray-300 rounded-md bg-gray-800 text-white">
                                                                <p class="error-msg text-red-500 text-sm font-semibold mt-1"
                                                                    style="display: none;">Dribble entre 10 et
                                                                    99</p>
                                                            </div>
                                                            <div>
                                                                <!-- <label for="defending">DEF</label> -->
                                                                <input type="number" placeholder="Défense"
                                                                    name="defending"
                                                                    class="p-2 border border-gray-300 rounded-md bg-gray-800 text-white">
                                                                <p class="error-msg text-red-500 text-sm font-semibold mt-1"
                                                                    style="display: none;">Défense entre 10 et
                                                                    99</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="form-error-msg"
                                                        class="text-red-500 text-sm font-semibold mt-2"
                                                        style="display: none;">
                                                ...
                                                <div class="flex justify-center mt-6">
                                                    <button type="submit"
                                                        ...
                                                        id="submit-btn" name="save">Enregistrer</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
